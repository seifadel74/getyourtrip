...
import { EyeIcon, XMarkIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
...
const BookingsManagement: React.FC = () => {
  ...
  const searchInBooking = useCallback((booking: Booking, term: string): boolean => {
    if (!term) return true;
      ...
      if (response.success && response.data) {
        ...
        if (filters.search) {
          filteredBookings = filteredBookings.filter(booking => 
            searchInBooking(booking, filters.search)
          );
        }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search by name, email, booking #, phone, or tour..."
                  ...
                  <td colSpan={8} className="px-6 py-12 text-center">
                    {filters.search ? (
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-500 font-medium">No bookings match your search</p>
                        <p className="text-sm text-gray-400 mt-1">Try different keywords or clear the search</p>
                        <button
